...
//        if (receiversNum) {
//            System.out.println("ReceiversNum Проверка пройдена");
//        }

        boolean valueCheck = Pattern.matches("(?<![-.])\\b[0-9]+\\b(?!\\.[0-9])", args[2]);
//        System.out.println("Проверка суммы:" + valueCheck);
...
//        if (numCheck) {
//            System.out.println("numCheck Проверка пройдена");
//        }
...
//            final Statement statement = connection.createStatement();
            ...
            if (args.length==3){
                preparedStatement.setString(1, Integer.toString(chooseFreeNum()));
